...
class Strategy31(StrategyBase):
    ...
    def __init__(self,stock,stockqtty,asset1,qtty1,fee):
        ...
        StrategyBase.__init__(self,"covered call",stock,stockqtty=stockqtty,asset1=asset1,qtty1=qtty1)
        ...
        vout2 = asset1.price + asset1.strike - stock.price
        out2 = np.full(split2.shape,vout2)


        #3. use split results to create function valued arrays

        #out 1 from split 1: output elements func = asset1.price + self.priceatmaturity[i] - stock.price 
        vout1 = asset1.price - stock.price 
