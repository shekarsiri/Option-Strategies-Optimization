...
class Strategy37(StrategyBase):
    ...
    def __init__(self,stock,asset1,qtty1,fee):
        ...
        StrategyBase.__init__(self,"short put",stock,asset1=asset1,qtty1=qtty1)
        ...
        #out 1 from split 1: output elements func = asset1.price + self.priceatmaturity[i] - asset1.strike
        vout1 = asset1.price - asset1.strike
