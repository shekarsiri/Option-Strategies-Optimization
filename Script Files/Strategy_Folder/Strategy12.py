...
class Strategy12(StrategyBase):
    ...
    def __init__(self,stock,asset1,qtty1,asset2,qtty2,asset3,qtty3,fee):
        ...
        vout1 = -asset1.price-asset3.price+(2*asset2.price)+asset3.strike-(2*asset2.strike)+asset1.strike
        ...
        vout4 = -asset1.price-asset3.price+(2*asset2.price)
        ...
        vout2 = -asset1.price-asset3.price+(2*asset2.price) +asset3.strike - (2* asset2.strike)
        ...
        vout3 = -asset1.price-asset3.price+(2*asset2.price) +asset3.strike
        out3 = [(vout3 - x) for x in split3]
        #out3 = np.asarray(out3e)
